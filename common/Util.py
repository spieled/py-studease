...
def equals(src, target):
    ...
    if not isinstance(target, str):
        return False
    return src.__eq__(target)


def json_response(success=True, msg=None):
...
#     return HttpResponse(json.dump('success', True))
...
if __name__ == '__main__':
    ...
    import timeit
    # 前者花费时间为后者的几乎26倍
    formatcost = timeit.timeit('"hello {0} {1}".format("world", "good")', number=10000)
